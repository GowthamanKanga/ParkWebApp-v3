...
.catch(error => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`http://localhost:3000/admin/update/${userId}`, {
        method: "PUT",
        headers: {
...
console.log(formData)
    try {
      const res = await fetch(`http://localhost:3000/admin/update/profileimg/${userId}`, {
        method: "PUT",
  ...
  const changePassword = async (e) => {
    ...
    try {
      const res = await fetch(
        `http://localhost:3000/admin/updatePassword/${userId}`,
        {
          method: "PUT",
          headers: {
            "content-type": "application/json",
